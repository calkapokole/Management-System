...
public class Qualification {
	...
	public void setQualification() {
		set.addAll(Arrays.asList(new String[] { "java", "python", "c", "c++",
				"c#", "php", "delphi", "scala", "perl", "ruby" }));
	}
	...
	/*
	 * Metoda zwraca liczbe miesiecy jakie przepracowal dany pracownik od czasu
	 * zatrudnienia
	 */
	public int getPractice(String firstName, String lastName) {
		date = worker.getDateEmployed();
		practice = (isYearNow() * 12 + isMonthNow())
				- (date.getYear() * 12 + date.getMonth());
		return practice;
	}

	/*
	 * Metoda zwraca aktualny czas w postaci Stringu o formacie: yyyy-MM-dd
	 */
	public String isNow() {
